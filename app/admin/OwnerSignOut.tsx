...
export default function OwnerSignOut() {
  ...
  return (
    <button
      ...
      className="ml-auto rounded-lg border border-white/25 px-3 py-1.5 text-[12px] font-semibold text-white/85 hover:border-white hover:text-white disabled:opacity-60"
    >
