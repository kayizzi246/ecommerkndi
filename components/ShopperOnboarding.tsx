      ...
      <div className="relative flex max-h-[92vh] w-full max-w-[560px] flex-col overflow-hidden bg-white sm:rounded-lg">
        ...
        <div className="flex items-center gap-3 border-b border-bfl-line px-6 py-4">
          ...
          <div className="min-w-0 flex-1">
            <p className="truncate text-[15px] font-semibold text-black">{steps[step]}</p>
        ...
        <div className="min-h-[240px] flex-1 overflow-y-auto px-6 py-6">
          ...
          {step === 1 && (
            <div className="space-y-6">
              <div>
                <p className="mb-2 text-[13px] font-semibold text-black">Usual clothing size</p>
                <div className="flex flex-wrap gap-2">
                  {SIZES.map((option) => (
                    <button
                      key={option}
              ...
              <div>
                <label className="mb-2 block text-[13px] font-semibold text-black" htmlFor="onboard-city">
          ...
          {step === 2 && (
            <div className="text-center">
              {customer ? (
                ...
                <>
                  <p className="text-[15px] font-semibold text-black">Save your picks to your account</p>
        ...
        <div className="flex items-center justify-between gap-3 border-t border-bfl-line px-6 py-4">
          {step > 0 ? (
            <button
              ...
              className="border border-bfl-line px-5 py-2.5 text-[13px] font-semibold text-[#333] hover:border-black"
            >
              Back
            </button>
          ) : (
